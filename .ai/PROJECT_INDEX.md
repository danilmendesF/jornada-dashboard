...
> **Última Atualização**: 2026-08-06T14:55:45.207Z | **Total Módulos js/**: 13 | **Commit**: `ef2ccfb`
...
|---|---|---|---|
| `js/auth.js` | 343 | 🟢 OK | `currentUser, getAuthToken, getCurrentUser, getClaimedPlayers, addClaimedPlayer...` |
...
### 📌 `manager.js` — Funções Críticas (3214 linhas total)
