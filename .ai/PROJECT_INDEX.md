...
|---|---|---|---|
| `js/auth.js` | ~261 | 🟢 Ativo | `currentUser, getAuthToken, getCurrentUser, getClaimedPlayers, addClaimedPlayer...` |
...
| `js/manager_forms.js` | ~251 | 🟢 Ativo | `editingMatchId, showModal, closeModal, openMatchForm, editingMatchId...` |
